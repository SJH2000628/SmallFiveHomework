Vue.component('jc-product-update-page', {
   ...
   <el-page-header @back="handleGoBack" content="商品編輯"></el-page-header>
    ...
    <el-select v-model="selectedStatus" placeholder="请选择状态">
        ...
        <el-upload ref="uploadMain" action="" :http-request="uploadMainImage" :limit="1" accept="image/*" :auto-upload="false"
            :on-change="handleOnMainChange" :file-list="mainFileList">
        ...
        <br>
        <br>
    <el-button type="primary" @click="handleUpdateClick" round>更新</el-button>
</div>
    `,
    data(){
        return{
